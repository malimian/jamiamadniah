            ...
            <div class="row align-items-start">
                <div class="col-lg-8 m-15px-tb">
                    <article class="article">
                        ...
                        ?>
                            <img class="img-fluid img-responsive" src="<?php echo ABSOLUTE_IMAGEPATH.$content['featured_image'];?>" title="<?php echo $content['page_title'];?>" alt="<?php echo $content['page_title'];?>"></div>
                		...
                		<div class="row">
                            ...
                            <div class="col-lg-5 col-md-4 col-xs-6 thumb">
                                <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title=""
                                   data-image="images/<?php echo $photogallery_['i_name'];?>"
                                   data-target="#image-gallery">
                                    <img class="img-thumbnail"
                                         src="images/<?php echo $photogallery_['i_name'];?>"
