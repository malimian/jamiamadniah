    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            ...
            <div class="d-inline-flex">
                ...
                <p class="m-0 px-2">-</p>
                <p class="m-0"><?php echo replace_sysvari($content['page_title']);?></p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="<?php echo ABSOLUTE_IMAGEPATH.$content['featured_image'];?>" alt="Image">
                        </div>
                         <?php
                        ...
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="<?php echo ABSOLUTE_IMAGEPATH.$photogallery_['i_name'];?>" alt="<?php echo $photogallery_['i_name'];?>">
                        </div>
                        <?php }}?>
                        </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold"><?php echo replace_sysvari($content['page_title']);?></h3>
                ...
                <h3 class="font-weight-semi-bold mb-4"><?php echo CURRENCY?> <?php echo $content['plistprice'];?></h3>
                <p class="mb-4"> <?php
