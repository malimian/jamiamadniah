                     ...
                     <div class="col-lg-12">
                        <form class="needs-validation" onsubmit="return false" novalidate>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                 <input type="text" class="form-control" id="page_title" required="required" placeholder="Enter Page title" name="page_title" value="">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                 <input type="text" class="form-control" id="page_url" required="required" placeholder="Page Url" name="page_url" value="">
                                 </div>
                                 <div class="col-sm-2">
                        		...
                        		<table class="table table-image">
                        		  ...
                        		  <tbody>
                        		    ...
                        		    <tr id="dr_<?php echo $photogallery_['i_id'];?>">
                        		      <td class="w-25">
                        			      <img src="/photo_gallery/<?php echo $photogallery_['i_name'];?>" class="img-fluid img-thumbnail" alt="Sheep">
                        		      </td>
