    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Update <?php echo $page['page_title']; ?></h3>
                    </div>
                </div>
                        ...
                        <div class="ib-action-bar card">
                            <div class="card-body py-2">
                                <div class="d-flex align-items-center">
                                    <?php if($has_add): ?>
                                        <a href="#" class="btn btn-sm btn-danger mr-2" data-toggle="modal" data-target="#addPageModal">
                                            <i class="fa fa-plus fa-fw"></i> Add New Page
                                        </a>
                                    <?php endif; ?>
