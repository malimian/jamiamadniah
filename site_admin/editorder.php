                     ...
                     <div class="col-lg-12">
                        <form class="needs-validation" onsubmit="return false" novalidate>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                 <textarea class="form-control" id="editor1" name="editor1" placeholder="Update Order Summary" name="editor1" ><?php echo $order_dh['order_summary'];?></textarea>
                                 <div class="valid-feedback">Valid.</div>
                                 <div class="invalid-feedback">Please fill out this field.</div>
                              </div>
                           </div>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-2" style="float:right;">
                                 <input type="submit" name="submit" class="form-control btn btn-info" value="Update" id="submit_btn" />
                              </div>
                           </div>
                        </form>
                        <script type="text/javascript">
                           var order_id = "<?php echo $order_dh['order_id']; ?>";
                        </script>
                        
                        <script type="text/javascript" src="js/order/editorder.js"></script>
