...
<?php
         $page = return_single_row("Select * from products Where pid  = ".$_GET['id']." $and_gc ");
   ?>
            ...
            <div id="page-content-wrapper">
                     ...
                     <div class="col-lg-12">
                        <form class="needs-validation" onsubmit="return false" novalidate>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                 <input type="text" class="form-control" id="sku" required="required" placeholder="Enter Product title" name="sku" value="<?php echo $page['UniqueCode']?>">
                                 <div class="valid-feedback">Valid.</div>
                                 <div class="invalid-feedback">Please fill out this field.</div>
                              </div>
                           </div>
                              ...
                              <div class="col-sm-10">
                                 <input type="number" min="0" class="form-control" id="plistprice" required="required" placeholder="Enter Product Price" name="plistprice" value="<?php echo $page['plistprice']?>" >
                                 <div class="valid-feedback">Valid.</div>
                                 <div class="invalid-feedback">Please fill out this field.</div>
                              </div>
                           </div>
               ...
               <div id="menu5" class="container tab-pane fade">              
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <div class="form-inline">
                                         <input type="text" value="<?php echo $page['featured_image1']; ?>" class="form-control col-sm-10" id="p_image1" placeholder="Choose Image" name="p_image1">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <div class="form-inline">
                                         <input type="text" value="<?php echo $page['featured_image2']; ?>" class="form-control col-sm-10" id="p_image2" placeholder="Choose Image" name="p_image2">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <div class="form-inline">
                                         <input type="text" value="<?php echo $page['featured_image3']; ?>" class="form-control col-sm-10" id="p_image3" placeholder="Choose Image" name="p_image3">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <div class="form-inline">
                                         <input type="text" value="<?php echo $page['featured_image4']; ?>" class="form-control col-sm-10" id="p_image4" placeholder="Choose Image" name="p_image4">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <div class="form-inline">
                                         <input type="text" value="<?php echo $page['featured_image5']; ?>" class="form-control col-sm-10" id="p_image5" placeholder="Choose Image" name="p_image5">
                  ...
                  <div id="menu4" class="container tab-pane fade">              
                              ...
                              <div class="form-group row">
                                 <div class="form-check">
                                   <input class="form-check-input" type="checkbox" value="" id="additionalCheck1" <?php echo $page['stock_status'] ? "checked" : ""; ?> >
                               ...
                               <div class="form-group row">
                                 <div class="form-check">
                                   <input class="form-check-input" type="checkbox" value="" id="additionalCheck2" <?php echo $page['new_arrivals'] ? "checked" : ""; ?>>
                               ...
                               <div class="form-group row">
                                 <div class="form-check">
                                   <input class="form-check-input" type="checkbox" value="" id="additionalCheck3" <?php echo $page['featured_product'] ? "checked" : ""; ?>>
                               ...
                               <div class="form-group row">
                                 <div class="form-check">
                                   <input class="form-check-input" type="checkbox" value="" id="additionalCheck4" <?php echo $page['on_sale'] ? "checked" : ""; ?>>
                               ...
                               <div class="form-group row">
                                 <div class="form-check">
                                   <input class="form-check-input" type="checkbox" value="" id="additionalCheck5" <?php echo $page['best_seller'] ? "checked" : ""; ?>>
                              ...
                              <div class="form-group row">
                                 <div class="form-check">
                                   <input class="form-check-input" type="checkbox" value="" id="additionalCheck6" <?php echo $page['trending_item'] ? "checked" : ""; ?>>
                               ...
                               <div class="form-group row">
                                 <div class="form-check">
                                   <input class="form-check-input" type="checkbox" value="" id="additionalCheck7" <?php echo $page['hot_item'] ? "checked" : ""; ?>>
                        ...
                        <script type="text/javascript" src="js/product/editproduct.js"></script>
