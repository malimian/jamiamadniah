...
validateform(function(){
    ...
    senddata
    ('post/payments/addpayments.php' ,"POST", {
    ...
    function(result){
     ...
     $('#ptitle').val('');      
      $('#error_id').empty();
      $('#error_id').html('<div class="alert alert-success alert-dismissible fade show" role="alert"> <strong>Success !</strong> Payment Added Successfully <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">&times;</span> </button> </div>');
