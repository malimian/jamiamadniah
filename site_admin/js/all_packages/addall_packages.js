...
validateform(function(){
    ...
    senddata
    ('post/all_packages/addall_packages.php' ,"POST", {
        ptitle:ptitle,
        p_image:p_image,
        p_cost:p_cost,
    ...
    function(result){
     ...
     $('#ptitle').val('');      
      $('#error_id').empty();
      $('#error_id').html('<div class="alert alert-success alert-dismissible fade show" role="alert"> <strong>Success !</strong> New Package Added Successfully <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">&times;</span> </button> </div>');
